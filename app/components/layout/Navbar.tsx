    ...
    <nav className="font-mono  border-b-2 border-gray-200 shadow-sm rounded-lg">
      <div className="flex justify-between py-6 w-[95%] sm:w-[90%] mx-auto items-center">
        <div className='items-center flex w-full'>
          <Link href="/" className="group transition duration-200 ease-in-out text-xl md:text-2xl lg:text-2xl font-semibold hover:text-rose-500">
        ...
        <div className="hidden sm:flex space-x-5 text-lg items-center">
          ...
          <Link className="hover:text-cyan-500 transition duration-200 ease-in-out" href="/blogs">Blogs</Link>
          {token ? (
            <svg
      ...
      {isOpen && (
        <div className="sm:hidden bg-white shadow-md rounded-b-lg border-t-[1px] border-t-gray-300">
          <div className='space-y-3 py-3 w-[90%] mx-auto'>
            ...
            <Link href="/blogs" className="block text-xl text-center font-bold border-b-[1px] border-gray-300 pb-2">Blogs</Link>
